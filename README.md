# 🚀 Muhammad Zil Ur Rehman - Portfolio
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/ZilatAIOBC/ZilatAIOBC.github.io.git
   cd portfolio
   ```
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://zilataiobc.github.io/).

## 👨‍💻 Author

**Muhammad Zil Ur Rehman**

- Portfolio: [https://zilataiobc.github.io/](https://zilataiobc.github.io/)
- GitHub: [@ZilatAIOBC](https://github.com/ZilatAIOBC)
- LinkedIn: [LinkedIn](https://www.linkedin.com/in/muhammad-zil-ur-rehman/)
- Email: zilataiobc@gmail.com
