        ...
        <div className='container'>
          ...
          <div className='content flex1'>
            ...
            <div className='right w-40 ml'>
              <img src='/images/s0.jpg' alt='Img' className='round' width='100%' height='100%' />
            </div>
          </div>
          ...
          <div className='content flex'>
            ...
            <div className='right w-60 ml'>
              ...
              <p className='misson-p'>To empower businesses through cutting-edge software solutions, fostering growth and digital transformation in an ever-evolving technological landscape.</p>
            </div>
          </div>
